...
$MESS["IBLOCK_ADD_LINKED_USER_PROP_ERROR"] = "Не установлен связанный инфоблок для свойства-привязки к пользователю";
$MESS["IBLOCK_USER_LINK_PROPERTY_ERROR"] = "Не выбрано свойство - привязка к пользователю в свзанном инфоблоке";
...
$MESS["IBLOCK_ADD_NEED_AGREEMENT"] = "Необходимо принять пользовательское соглашение";
?>